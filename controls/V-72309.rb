...
If \"net.ipv4.ip_forward\" is not configured in the /etc/sysctl.conf file or in the 
...
If IP forwarding value is \"1\" and the system is hosting any application, database, or web 
