...
control "SV-204409" do
  title "The Red Hat Enterprise Linux operating system must be configured so that 
    when passwords are changed or new passwords are assigned, the new password 
  ...
  desc "default", "Use of a complex password helps to increase the time and 
    ...
    compromised."
  desc "check", "Note: The value to require a number of numeric characters to 
  ...
  desc "fix", "Configure the operating system to enforce password complexity by 
    requiring that at least one numeric character be used by setting the \"dcredit\" option.
