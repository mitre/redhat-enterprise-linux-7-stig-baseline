...
Check for the value of the \"remember\" argument in \"/etc/pam.d/system-auth\" and 
...
If the line containing the \"pam_pwhistory.so\" line does not have the \"remember\" module 
argument set, is commented out, or the value of the \"remember\" module argument is set to less 
...
Add the following line in \"/etc/pam.d/system-auth\" and \"/etc/pam.d/password-auth\" (or 
