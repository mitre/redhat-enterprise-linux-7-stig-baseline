...
control "SV-204550" do
  ...
  desc "Reconstruction of harmful events or forensic analysis is not possible 
    ...
    privileged access commands. The organization must maintain audit trails 
    in sufficient detail to reconstruct events to determine the cause and 
  ...
  desc "default", "Reconstruction of harmful events or forensic analysis is not 
    ...
    the organization must audit the full-text recording of privileged access 
    commands. The organization must maintain audit trails in sufficient detail 
  ...
  desc "check", "Verify the operating system generates audit records when 
    ...
    Check that the following system call is being audited by performing the following 
