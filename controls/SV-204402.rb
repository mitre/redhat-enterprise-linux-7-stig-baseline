...
control "SV-204402" do
  ...
  desc "default", "A session time-out lock is a temporary action taken when a 
    ...
    to initiate the session lock. The session lock is implemented at the point 
    where session activity can be determined and/or controlled."
  ...
  desc "fix", "Configure the operating system to initiate a session lock after 
    a 15-minute period of inactivity for graphical user interfaces.
