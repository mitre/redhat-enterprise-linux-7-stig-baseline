...
control "SV-204600" do
  ...
  desc "default", "If other users have access to modify user-specific SSH 
    configuration files, they may be able to log on to the system as another user."
  ...
  desc "fix", "Uncomment the \"StrictModes\" keyword in \"/etc/ssh/sshd_config\" 
    ...
    version of SSH that is provided by a third-party vendor) and set the value 
    to \"yes\":
