...
control "SV-204486" do
  ...
  desc "default", "The \"noexec\" mount option causes the system to not execute 
    ...
    users to attain unauthorized administrative access. The \"nodev\" mount option 
    causes the system to not interpret character or block special devices. Executing 
    character or block special devices from untrusted file systems increases the 
    ...
    Executing files from untrusted file systems increases the opportunity for 
    unprivileged users to attain unauthorized administrative access."
  desc "check", "Verify that the \"nodev\",\"nosuid\", and \"noexec\" options 
    are configured for /dev/shm:
