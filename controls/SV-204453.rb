...
control "SV-204453" do
  ...
  desc "default", "Without verification of the security functions, security 
    ...
    and environments that require this functionality."
  ...
  desc "fix", "Configure the operating system to verify correct operation of 
    ...
    Set the \"SELinux\" status and the \"Enforcing\" mode by modifying the \"/etc/selinux/config\" 
