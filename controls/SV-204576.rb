...
control "SV-204576" do
  title "The Red Hat Enterprise Linux operating system must limit the number 
    of concurrent sessions to 10 for all accounts and/or account types."
  desc "Operating system management includes the ability to control the number 
    ...
    number of allowed users and sessions per user is helpful in reducing the 
    ...
    multiple system accounts. The maximum number of concurrent sessions 
    should be defined based on mission needs and the operational 
    environment for each system."
  desc "default", "Operating system management includes the ability to control 
    ...
    in reducing the risks related to DoS attacks. This requirement addresses 
  ...
  desc "check", "Verify the operating system limits the number of concurrent 
    ...
    * hard maxlogins 10
    ...
    If the \"maxlogins\" item is missing, commented out, or the value is not set to 
    \"10\" or less for all domains that have the \"maxlogins\" item assigned, this 
    is a finding."
