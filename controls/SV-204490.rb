...
control "SV-204490" do
  ...
  desc "If the owner of the \"cron.allow\" file is not set to root, the 
    ...
    information."
  desc "default", "If the owner of the \"cron.allow\" file is not set to root, 
    the possibility exists for an unauthorized user to
  ...
  desc "check", "Verify that the \"cron.allow\" file is owned by root.
    ...
    If the \"cron.allow\" file exists and has an owner other than root, this 
    is a finding."
