...
If the user home directory referenced in \"/etc/passwd\" is not group-owned by that user's 
...
Note: The example will be for the user \"smithj\", who has a home directory of \"/home/smithj\", and 
