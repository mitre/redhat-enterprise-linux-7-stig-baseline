...
Check what action the operating system takes when the threshold for the repository maximum audit 
...
Uncomment or edit the \"space_left_action\" keyword in \"/etc/audit/auditd.conf\" and set it to 
\"email\". 
