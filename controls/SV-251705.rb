...
control "SV-251705" do
  title "The Red Hat Enterprise Linux operating system must use a file integrity 
    tool to verify correct operation of all security functions."
  desc "Without verification of the security functions, security functions may 
    ...
    This requirement applies to the Red Hat Enterprise Linux operating system 
    performing security function verification/testing and/or systems and 
  ...
  desc "default", "Without verification of the security functions, security 
    ...
    and supporting the isolation of code and data on which the protection is based. 
