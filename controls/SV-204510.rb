...
control "SV-204510" do
  title "The Red Hat Enterprise Linux operating system must encrypt the transfer 
    of audit records off-loaded onto a different system or media from the 
  ...
  desc "fix", "Configure the operating system to encrypt the transfer of off-loaded 
