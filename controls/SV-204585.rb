...
control "SV-204585" do
  ...
  desc "Without protection of the transmitted information, confidentiality and 
    ...
    physical means of protection are employed, logical means (cryptography) do 
  ...
  desc "default", "Without protection of the transmitted information, 
    ...
    interception and modification. Protecting the confidentiality and integrity 
    of organizational information can be accomplished by physical means
    (e.g., employing physical distribution systems) or by logical means 
    (e.g., employing cryptographic techniques). If physical means of protection 
    are employed, logical means (cryptography) do not have to be employed, and vice versa."
