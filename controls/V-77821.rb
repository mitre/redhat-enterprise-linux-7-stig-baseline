...
If the command does not return any output, or the line is commented out, and use of DCCP is not 
...
If the command does not return any output or the output is not \"blacklist dccp\", and use of the 
dccp kernel module is not documented with the Information System Security Officer (ISSO) as 
