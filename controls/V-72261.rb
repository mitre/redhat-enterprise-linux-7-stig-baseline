...
If the \"KerberosAuthentication\" keyword is missing, or is set to \"yes\" and is not 
documented with the Information System Security Officer (ISSO), or the returned line is 
...
If Kerberos authentication is required, it must be documented, to include the location of the 
