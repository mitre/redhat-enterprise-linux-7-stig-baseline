...
control "SV-204613" do
  ...
  desc "default", "Responding to broadcast (ICMP) echoes facilitates network 
  ...
  desc "check", "Verify the system does not respond to IPv4 ICMP echoes sent to 
    ...
    or does not have a value of \"1\", this is a finding.

    Check that the operating system implements the \"icmp_echo_ignore_broadcasts\" 
