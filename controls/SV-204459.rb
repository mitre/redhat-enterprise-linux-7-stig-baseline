...
Vulnerability Management (IAVM) process, this is a finding.
  ...
  tag check: 'Verify the operating system security patches and updates are installed and up to date. Updates are
    ...
    If package updates have not been performed on the system within the timeframe that the site/program documentation
    requires, this is a finding.
    Typical update frequency may be overridden by Information Assurance Vulnerability Alert (IAVA) notifications from
    CYBERCOM.
