...
control "SV-204582" do
  title "The Red Hat Enterprise Linux operating system must implement cryptography 
    to protect the integrity of Lightweight Directory Access Protocol (LDAP) communications."
  ...
  desc "check", "If LDAP is not being utilized, this requirement is Not Applicable.
    ...
    If the \"ldap_tls_reqcert\" setting is not set to \"demand\" or \"hard\", this 
    is a finding."
