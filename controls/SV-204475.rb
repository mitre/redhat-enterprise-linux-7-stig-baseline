control 'SV-204475' do
  ...
  desc 'rationale', ''
  desc 'check', 'Verify the local initialization files of all local interactive users are group-owned by that user\'s
    ...
    finding.'
  desc 'fix', 'Change the group owner of a local interactive user\'s files to the group found in "/etc/passwd" for the
