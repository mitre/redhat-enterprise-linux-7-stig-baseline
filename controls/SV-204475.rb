...
control "SV-204475" do
  ...
  desc "Local initialization files for interactive users are used to configure 
    the user's shell environment upon logon. Malicious modification of these 
    files could compromise accounts upon logon."
  desc "default", "Local initialization files for interactive users are used to 
    configure the user's shell environment upon logon. Malicious modification 
  ...
  desc "check", "Verify the local initialization files of all local interactive 
    ...
    Check the group owner of all local interactive user's initialization files with 
    ...
    If all local interactive user's initialization files are not group-owned by that 
