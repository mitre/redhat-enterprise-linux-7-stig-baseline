...
control "SV-204458" do
  ...
  desc "An operating system release is considered \"supported\" if the vendor 
    ...
    release, it will not be possible to resolve security issues discovered in 
    the system software.

    Red Hat offers the Extended Update Support (EUS) Add-On to a Red Hat 
    Enterprise Linux subscription, for a fee, for those customers who wish 
    to standardize on a specific minor release for an extended period. RHEL 7.7 
    marks the final minor release that EUS will be available, while 7.9 is the 
    final minor release overall."
  desc "default", "An operating system release is considered \"supported\" if 
    the vendor continues to provide security patches for the product. With an 
    ...
    fee, for those customers who wish to standardize on a specific minor 
    release for an extended period. RHEL 7.7 marks the final minor release 
    that EUS will be available, while 7.9 is the final minor release overall."
