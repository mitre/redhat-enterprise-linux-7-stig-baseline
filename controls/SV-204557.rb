...
control "SV-204557" do
  ...
  desc "default", "Reconstruction of harmful events or forensic analysis is not 
    ...
    the organization must audit the full-text recording of privileged commands. 
    ...
    the auid is set to the uid of the account that is being authenticated. 
    Daemons are not user sessions and have the loginuid set to -1. The auid 
    representation is an unsigned 32-bit integer, which equals
    4294967295. The audit system interprets -1, 4294967295, and \"unset\" 
    in the same way."
