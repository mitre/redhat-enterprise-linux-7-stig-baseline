...
control "SV-204583" do
  title "The Red Hat Enterprise Linux operating system must implement 
    cryptography to protect the integrity of Lightweight Directory Access 
    Protocol (LDAP) communications."
  ...
  desc "check", "If LDAP is not being utilized, this requirement is Not Applicable.
    ...
    Verify the \"ldap_tls_cacert\" option points to a file that contains the trusted 
    CA certificate.
