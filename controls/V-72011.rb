...
there is no place for the storage and control of files they should own."
  desc  "rationale", ""
  desc "check", "Verify local interactive users on the system have a home directory assigned.
...
Ask the System Administrator (SA) if any users found without home directories are local 
interactive users. If the SA is unable to provide a response, check for users with a User 
Identifier (UID) of 1000 or greater with the following command:
