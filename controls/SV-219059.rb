...
control "SV-219059" do
  title "The Red Hat Enterprise Linux operating system must disable the graphical 
    user interface automounter unless required."
  desc "Automatically mounting file systems permits easy introduction of unknown 
    devices, thereby facilitating malicious activity."
  desc "default", "Automatically mounting file systems permits easy introduction 
  ...
  desc "check", "Note: If the operating system does not have a graphical user 
    ...
    Verify the operating system disables the ability to automount devices in a 
  ...
  desc "fix", "Configure the graphical user interface to disable the ability 
    ...
    Create or edit the /etc/dconf/db/local.d/00-No-Automount file and add the 
    following:  
    ...
    Create or edit the /etc/dconf/db/local.d/locks/00-No-Automount file and add the 
    following:
    /org/gnome/desktop/media-handling/automount
